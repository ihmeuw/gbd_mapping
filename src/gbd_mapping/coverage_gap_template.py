...
class CoverageGaps(GbdRecord):
    ...
    __slots__ = ('low_measles_vaccine_coverage_first_dose', 'lack_of_lipid_lowering_therapy',
                 'low_oral_rehydration_solution_coverage', 'lack_of_maternal_calcium_supplement',
                 'lack_of_hiv_positive_antiretroviral_treatment', 'lack_of_immediate_assessment_and_stimulation',
                 'lack_of_breastfeeding_promotion', )
