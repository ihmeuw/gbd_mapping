...
class RiskFactor(ModelableEntity):
    ...
    __slots__ = (
        ...
        "most_detailed",
        "distribution",
        "population_attributable_fraction_calculation_type",
        "restrictions",
        "affected_causes",
    ...
    def __init__(
        ...
        self.population_attributable_fraction_calculation_type = (
            population_attributable_fraction_calculation_type
        )
        self.restrictions = restrictions
        self.affected_causes = affected_causes
        self.population_attributable_fraction_of_one_causes = (
            population_attributable_fraction_of_one_causes
        )
        self.parent = parent
...
class RiskFactors(GbdRecord):
    ...
    __slots__ = (
        "unsafe_water_sanitation_and_handwashing",
        "unsafe_water_source",
        "unsafe_sanitation",
        "air_pollution",
        ...
        "other_environmental_risks",
        "residential_radon",
        "lead_exposure",
        "child_and_maternal_malnutrition",
        "suboptimal_breastfeeding",
        "child_underweight",
        "iron_deficiency",
        ...
        "diet_low_in_milk",
        "diet_high_in_red_meat",
        "diet_high_in_processed_meat",
        "diet_high_in_sugar_sweetened_beverages",
        "diet_low_in_fiber",
        "diet_low_in_seafood_omega_3_fatty_acids",
        "diet_low_in_omega_6_polyunsaturated_fatty_acids",
        "diet_high_in_trans_fatty_acids",
        "diet_high_in_sodium",
        "low_physical_activity",
        "occupational_risks",
        "occupational_carcinogens",
        "occupational_asthmagens",
        "occupational_particulate_matter_gases_and_fumes",
        "occupational_noise",
        "occupational_injuries",
        "occupational_ergonomic_factors",
        ...
        "drug_dependence",
        "diet_low_in_calcium",
        "occupational_exposure_to_asbestos",
        "occupational_exposure_to_arsenic",
        "occupational_exposure_to_benzene",
        "occupational_exposure_to_beryllium",
        "occupational_exposure_to_cadmium",
        "occupational_exposure_to_chromium",
        "occupational_exposure_to_diesel_engine_exhaust",
        "occupational_exposure_to_formaldehyde",
        "occupational_exposure_to_nickel",
        "occupational_exposure_to_polycyclic_aromatic_hydrocarbons",
        "occupational_exposure_to_silica",
        "occupational_exposure_to_sulfuric_acid",
        "intimate_partner_violence_exposure_approach",
        "intimate_partner_violence_direct_paf_approach",
        "all_risk_factors",
        "unsafe_sex",
        "intimate_partner_violence_hiv_paf_approach",
        "environmental_occupational_risks",
        "behavioral_risks",
        "occupational_exposure_to_trichloroethylene",
        "no_access_to_handwashing_facility",
        "child_growth_failure",
        "child_wasting",
        "child_stunting",
        "lead_exposure_in_blood",
        "lead_exposure_in_bone",
        "childhood_sexual_abuse_against_females",
        "childhood_sexual_abuse_against_males",
        "non_optimal_temperature",
        "chewing_tobacco",
        "diet_low_in_legumes",
        "short_gestation",
        "low_birth_weight",
        ...
        "high_body_mass_index_in_children",
        "particulate_matter_pollution",
        "childhood_sexual_abuse_and_bullying",
    ...
    def __init__(
        ...
        self.household_air_pollution_from_solid_fuels = (
            household_air_pollution_from_solid_fuels
        )
        ...
        self.diet_low_in_omega_6_polyunsaturated_fatty_acids = (
            diet_low_in_omega_6_polyunsaturated_fatty_acids
        )
        ...
        self.occupational_particulate_matter_gases_and_fumes = (
            occupational_particulate_matter_gases_and_fumes
        )
        ...
        self.occupational_exposure_to_diesel_engine_exhaust = (
            occupational_exposure_to_diesel_engine_exhaust
        )
        ...
        self.intimate_partner_violence_exposure_approach = (
            intimate_partner_violence_exposure_approach
        )
        self.intimate_partner_violence_direct_paf_approach = (
            intimate_partner_violence_direct_paf_approach
        )
        self.all_risk_factors = all_risk_factors
        self.unsafe_sex = unsafe_sex
        self.intimate_partner_violence_hiv_paf_approach = (
            intimate_partner_violence_hiv_paf_approach
        )
        self.environmental_occupational_risks = environmental_occupational_risks
        self.behavioral_risks = behavioral_risks
        self.occupational_exposure_to_trichloroethylene = (
            occupational_exposure_to_trichloroethylene
        )
