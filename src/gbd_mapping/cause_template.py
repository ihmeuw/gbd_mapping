...
class Causes(GbdRecord):
    ...
    __slots__ = ('all_causes', 'hiv_aids_resulting_in_other_diseases', 'diarrheal_diseases', 'typhoid_fever',
                 ...
                 'late_maternal_deaths', 'other_maternal_disorders', 'neonatal_preterm_birth',
                 ...
                 'vitamin_a_deficiency', 'dietary_iron_deficiency', 'other_nutritional_deficiencies', 'syphilis',
                 'chlamydial_infection', 'gonococcal_infection', 'trichomoniasis', 'genital_herpes',
                 'other_sexually_transmitted_infections', 'acute_hepatitis_a', 'acute_hepatitis_b',
                 'acute_hepatitis_c', 'acute_hepatitis_e', 'leprosy', 'other_unspecified_infectious_diseases',
                 'esophageal_cancer', 'stomach_cancer', 'liver_cancer_due_to_hepatitis_b',
                 ...
                 'ovarian_cancer', 'testicular_cancer', 'kidney_cancer', 'bladder_cancer',
                 'brain_and_nervous_system_cancer', 'thyroid_cancer', 'mesothelioma', 'hodgkin_lymphoma',
                 'non_hodgkin_lymphoma', 'multiple_myeloma', 'other_malignant_neoplasms', 'rheumatic_heart_disease',
                 'ischemic_heart_disease', 'ischemic_stroke', 'intracerebral_hemorrhage', 'subarachnoid_hemorrhage',
                 'hypertensive_heart_disease', 'atrial_fibrillation_and_flutter', 'aortic_aneurysm',
                 'peripheral_artery_disease', 'endocarditis', 'other_cardiovascular_and_circulatory_diseases',
                 'chronic_obstructive_pulmonary_disease', 'silicosis', 'asbestosis', 'coal_workers_pneumoconiosis',
                 'other_pneumoconiosis', 'asthma', 'interstitial_lung_disease_and_pulmonary_sarcoidosis',
                 ...
                 'gastroesophageal_reflux_disease', 'other_digestive_diseases',
                 'alzheimers_disease_and_other_dementias', 'parkinsons_disease', 'epilepsy', 'multiple_sclerosis',
                 'migraine', 'tension_type_headache', 'motor_neuron_disease', 'other_neurological_disorders',
                 'schizophrenia', 'alcohol_use_disorders', 'opioid_use_disorders', 'cocaine_use_disorders',
                 ...
                 'anorexia_nervosa', 'bulimia_nervosa', 'autism_spectrum_disorders',
                 'attention_deficit_hyperactivity_disorder', 'conduct_disorder',
                 'idiopathic_developmental_intellectual_disability', 'other_mental_disorders',
                 'acute_glomerulonephritis', 'chronic_kidney_disease_due_to_hypertension',
                 'chronic_kidney_disease_due_to_glomerulonephritis',
                 'chronic_kidney_disease_due_to_other_and_unspecified_causes', 'urinary_tract_infections',
                 ...
                 'digestive_congenital_anomalies', 'other_congenital_birth_defects', 'psoriasis', 'cellulitis',
                 'pyoderma', 'scabies', 'fungal_skin_diseases', 'viral_skin_diseases', 'acne_vulgaris',
                 'alopecia_areata', 'pruritus', 'urticaria', 'decubitus_ulcer',
                 'other_skin_and_subcutaneous_diseases', 'glaucoma', 'cataract', 'age_related_macular_degeneration',
                 'age_related_and_other_hearing_loss', 'other_vision_loss', 'other_sense_organ_diseases',
                 'caries_of_deciduous_teeth', 'caries_of_permanent_teeth', 'periodontal_diseases',
                 'edentulism_and_severe_tooth_loss', 'other_oral_disorders', 'sudden_infant_death_syndrome',
                 'pedestrian_road_injuries', 'cyclist_road_injuries', 'motorcyclist_road_injuries',
                 'motor_vehicle_road_injuries', 'other_road_injuries', 'other_transport_injuries', 'falls',
                 'drowning', 'fire_heat_and_hot_substances', 'poisoning_by_carbon_monoxide',
                 'poisoning_by_other_means', 'unintentional_firearm_injuries', 'other_exposure_to_mechanical_forces',
                 'adverse_effects_of_medical_treatment', 'venomous_animal_contact', 'non_venomous_animal_contact',
                 ...
                 'cirrhosis_due_to_nash', 'diabetes_mellitus_type_1', 'diabetes_mellitus_type_2',
                 'atopic_dermatitis', 'contact_dermatitis', 'seborrhoeic_dermatitis',
    ...
    def __init__(self, **kwargs):
        ...
        self.urinary_tract_infections = kwargs.get('urinary_tract_infections')
        ...
        self.cirrhosis_due_to_nash = kwargs.get('cirrhosis_due_to_nash')
