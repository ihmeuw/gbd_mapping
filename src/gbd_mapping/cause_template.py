...
class Cause(ModelableEntity):
    ...
    __slots__ = ('name', 'kind', 'gbd_id', 'dismod_id', 'most_detailed', 'parent_cause', 'restrictions', 'subcauses',
                 'sequelae', 'etiologies', )
...
class Causes(GbdRecord):
    ...
    __slots__ = ('all_causes', 'communicable_maternal_neonatal_and_nutritional_diseases', 'tuberculosis', 'hiv_aids',
                 ...
                 'upper_respiratory_infections', 'otitis_media', 'meningitis', 'pneumococcal_meningitis',
                 'h_influenzae_type_b_meningitis', 'meningococcal_meningitis', 'other_meningitis', 'encephalitis',
                 'diphtheria', 'whooping_cough', 'tetanus', 'measles', 'varicella_and_herpes_zoster',
                 ...
                 'bladder_cancer', 'brain_and_nervous_system_cancer', 'thyroid_cancer', 'mesothelioma',
                 ...
                 'peripheral_artery_disease', 'endocarditis', 'non_rheumatic_valvular_heart_disease',
                 'other_cardiovascular_and_circulatory_diseases', 'chronic_respiratory_diseases',
                 ...
                 'urinary_diseases_and_male_infertility', 'urinary_tract_infections', 'urolithiasis',
                 'benign_prostatic_hyperplasia', 'male_infertility', 'other_urinary_diseases',
                 ...
                 'caries_of_permanent_teeth', 'periodontal_diseases', 'edentulism_and_severe_tooth_loss',
                 ...
                 'cirrhosis_due_to_nash', 'headache_disorders', 'substance_use_disorders',
                 'diabetes_and_kidney_diseases', 'diabetes_mellitus_type_1', 'diabetes_mellitus_type_2',
                 'atopic_dermatitis', 'contact_dermatitis', 'seborrhoeic_dermatitis', 'bacterial_skin_diseases',
                 'blindness_and_vision_impairment', 'upper_digestive_system_diseases',
    ...
    def __init__(self, **kwargs):
        ...
        self.blindness_and_vision_impairment = kwargs.get('blindness_and_vision_impairment')
