...
class Covariate(ModelableEntity):
    ...
    __slots__ = ('name', 'kind', 'gbd_id', 'by_age', 'by_sex', 'dichotomous', 'data_exist', 'low_value_exist',
                 'upper_value_exist', 'mean_value_exist', 'sex_restriction_violated', 'age_restriction_violated', )
